...
<div class="span9"><!-- have 12 columns with 3 columns sidebar and 9 column hero-unit -->
           ...
           <div id="this-carousel" class="carousel slide">
               <div class="carousel-inner">
                   <div class="item active">
                       ...
                       <!--<img src="//localhost/wordpress/wp-content/themes/the4reich/images/battlefield4/4th_images2b.jpg" alt="battlefield4 image"> -->
                   ...
                   <div class="item">
                      ...
                      <!-- <img src="//localhost/wordpress/wp-content/themes/the4reich/images/rainbowSix/the4_images38b.jpg" alt="rainbowSix image"> -->
                       <div class="carousel caption">
                            <p>Caption text here.</p>
                       </div>
                   </div>
                   ...
                   <p><a href="#" class="btn btn-primary btn-large">Read More;</a></p>
       ...
       <div class="row-fluid">
           <div class="span10">
              ...
              <!--  <img src="//localhost/wordpress/wp-content/themes/the4reich/images/battlefield4/the4_images7c.jpg" alt="battlefield4 image"> -->
       ...
       <div class="row-fluid">
           <div class="span4">
               ...
               <!-- <img src="//localhost/wordpress/wp-content/themes/the4reich/images/soul-calibur-5g.jpg" alt="soul-calibur 5 image"> -->
               <p>Soul Calibur 5 is slated to be the best one yet!!! </p>
               <p><a class="btn" href="#">View details &raquo;</a></p>
           </div><!--/span-->
           <div class="span4">
               <h2>Become A Zombie Herder In Moving Hazard - Review</h2>
               <img src = "<?php bloginfo('stylesheet_directory'); ?>/images/movinghazard1217-200c.jpg" alt="movinghazard1217 image"/>
              <!--  <img src="//localhost/wordpress/wp-content/themes/the4reich/images/movinghazard1217-200c.jpg" alt="movinghazard1217 image"> -->
               <p><a class="btn" href="#">Preview &raquo;</a></p>
           </div><!--/span-->
           <div class="span4">
               <h2>The Wither Storm - Rampages In Minecraft - Review</h2>
               <img src = "<?php bloginfo('stylesheet_directory'); ?>/images/minescraftc.jpg" alt="minecraft image"/>
               <!-- <img src="//localhost/wordpress/wp-content/themes/the4reich/images/minescraftc.jpg" alt="minecraft image"> -->
               <p><a class="btn" href="#">View details &raquo;</a></p>
           </div><!--/span-->
       ...
       <div class="row-fluid">
           <div class="span8">
               ...
               <img src = "<?php bloginfo('stylesheet_directory'); ?>/images/RainbowSix/rainbowSix610c.jpg" alt="RainbowSix610 image"/>
               <!-- <img src="//localhost/wordpress/wp-content/themes/the4reich/images/RainbowSix/RainbowSix610c.jpg" alt="RainbowSix610 image"> --><p></p>
               <img src = "<?php bloginfo('stylesheet_directory'); ?>/images/rainbowSix/Rappel610c.jpg" alt="RainbowSix610 rappel image"/>
               <!-- <img src="//localhost/wordpress/wp-content/themes/the4reich/images/RainbowSix/Rappel610c.jpg" alt="RainbowSix610rappel image"> -->
               <p><a class="btn" href="#">View details &raquo;</a></p>
           </div><!--/span-->
           <div class="span4">
       ...
       <div class="row-fluid">
        ...
        </div><!--/ end of span column container -->
</div> <!-- end of spam 9 hero -->     
